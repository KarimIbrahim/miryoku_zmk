...
U_MT_L(LGUI, Q),     U_MT_L(LALT, S),     U_MT_L(LCTRL, D),    U_MT_L(LSHFT, F),    &kp G,             &kp H,             U_MT_R(LSHFT, J),    U_MT_R(LCTRL, K),    U_MT_R(LALT, L),     U_MT_R(LGUI, M),     \
U_LT(U_BUTTON, W), U_MT_L(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp COMMA,         &kp DOT,           U_MT_R(RALT, SLASH), U_LT(U_BUTTON, SQT),\
...
U_MT_L(LGUI, Y),     U_MT_L(LALT, I),     U_MT_L(LCTRL, E),    U_MT_L(LSHFT, A),    &kp DOT,           &kp D,             U_MT_R(LSHFT, S),    U_MT_R(LCTRL, T),    U_MT_R(LALT, N),     U_MT_R(LGUI, B),     \
U_LT(U_BUTTON, J), U_MT_L(RALT, SLASH), &kp COMMA,         &kp K,             &kp SQT,           &kp W,             &kp M,             &kp L,             U_MT_R(RALT, P),     U_LT(U_BUTTON, V), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT_L(LGUI, A),     U_MT_L(LALT, R),     U_MT_L(LCTRL, S),    U_MT_L(LSHFT, T),    &kp G,             &kp K,             U_MT_R(LSHFT, N),    U_MT_R(LCTRL, E),    U_MT_R(LALT, I),     U_MT_R(LGUI, O),     \
U_LT(U_BUTTON, Z), U_MT_L(RALT, X),     &kp C,             &kp D,             &kp V,             &kp M,             &kp H,             &kp COMMA,         U_MT_R(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK_FLIP \
&kp SQT,           &kp COMMA,         &kp DOT,           &kp P,             &kp Y,             &kp F,             &kp G,             &kp C,             &kp R,             &kp L,             \
U_MT_L(LGUI, A),     U_MT_L(LALT, O),     U_MT_L(LCTRL, E),    U_MT_L(LSHFT, U),    &kp I,             &kp D,             U_MT_R(LSHFT, H),    U_MT_R(LCTRL, T),    U_MT_R(LALT, N),     U_MT_R(LGUI, S),     \
U_LT(U_BUTTON, SLASH),U_MT_L(RALT, Q),     &kp J,             &kp K,             &kp X,             &kp B,             &kp M,             &kp W,             U_MT_R(RALT, V),     U_LT(U_BUTTON, Z), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK_FLIP \
&kp W,             &kp L,             &kp R,             &kp B,             &kp Z,             &kp SQT,           &kp Q,             &kp U,             &kp D,             &kp J,             \
U_MT_L(LGUI, S),     U_MT_L(LALT, H),     U_MT_L(LCTRL, N),    U_MT_L(LSHFT, T),    &kp COMMA,         &kp DOT,           U_MT_R(LSHFT, A),    U_MT_R(LCTRL, E),    U_MT_R(LALT, O),     U_MT_R(LGUI, I),     \
U_LT(U_BUTTON, F), U_MT_L(RALT, M),     &kp V,             &kp C,             &kp SLASH,         &kp G,             &kp P,             &kp X,             U_MT(RALT, K),     U_LT(U_BUTTON, Y), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP
