...
&kp TILDE,  &kp CARET,           U_NA,                  &kp BSLH,   U_NA,      &kp QMARK,   &kp LBKT,  &kp RBKT,             &kp EXCL,            U_NA,  \ U_NP,       U_NP,                U_NA,                  U_NA,       U_NA,      U_NA,   U_NA,      U_NA,                 U_NP,                U_NP

// #define MIRYOKU_LAYER_SYM \
// &kp EXCL,   &kp AT,            &kp HASH,            &kp DLLR,   &kp PRCNT,  &kp CARET,  &kp AMPS,  &kp ASTRK,          &kp LPAR,          &kp RPAR,      \
// &kp MINUS,  U_MT(LALT, PLUS),  U_MT(LCTRL, UNDER),  &kp EQUAL,  U_NA,       U_NA,       U_NA,      U_MT(RCTRL, LBRC),  U_MT(RALT, LBRC),  &kp RBRC,  \
// &kp GRAVE,  U_NA,              U_NA,                &kp TILDE,  U_NA,       U_NA,       U_NA,      U_NA,               &kp LBKT,          &kp RBKT,  \
...
Base
Sym -> use both <- Spc bar (left)
Nav -> use right <- Bspc (left)
Media -> use right <- 3rd thumb (left)
FUN + NUM -> use left <- DEL (right)
